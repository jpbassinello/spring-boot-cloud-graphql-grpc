...
[![Spring gRPC](https://img.shields.io/badge/Spring%20gRPC-1.1.1-blue.svg)](https://docs.spring.io/spring-grpc/reference/)
...
enterprise-grade architecture patterns and best practices. Built with **Spring Boot 4.1.1** and **Spring Cloud 2025.1.3
...
- [Spring Cloud](https://spring.io/projects/spring-cloud) 2025.1.3 - Microservices toolkit
- [Spring Security](https://spring.io/projects/spring-security) 7.1.1 - Security framework
- [Java](https://openjdk.java.net/) 25 (LTS) - Programming language

### Communication & Infrastructure

- [Spring gRPC](https://docs.spring.io/spring-grpc/reference/) 1.1.1 - High-performance RPC framework
...
- [PostgreSQL](https://www.postgresql.org/) 18.6 - Relational database
- [HikariCP](https://github.com/brettwooldridge/HikariCP) - JDBC connection pool
- [Flyway](https://flywaydb.org/) - Database migration tool
- [Redis](https://redis.io/) 8.10.1 - Distributed cache

### Observability & Monitoring

- [OpenTelemetry](https://opentelemetry.io/) 2.28.1 - Distributed tracing and logging
- [Grafana LGTM Stack](https://grafana.com/docs/opentelemetry/docker-lgtm/) 0.33.0 - Loki (logs), Grafana (
...
- [Keycloak](https://www.keycloak.org/) 26.7.3 - Identity and access management

### Developer Tools

- [MapStruct](https://mapstruct.org/) 1.6.3 - Type-safe bean mapping
- [Lombok](https://projectlombok.org/) - Boilerplate reduction
- [ShedLock](https://github.com/lukas-krecan/ShedLock) 7.10.1 - Distributed lock
